...
def handle(req):
    ...
    system_prompt = """
    Answer only in structured json.
    ...
    Evaluate the following text and determine how similar it is to fake or misleading content. Provide a score between 0 and 1, where 0 means not at all similar and 1 means extremely similar. Then provide a justification for the score. 
    """
