		...
		properties: [
			{
				...
				options: [
					...
					{ name: 'Delete Last Messages', value: 'deleteLastMessages' },
					...
					{ name: 'Get File URL', value: 'getFileUrl' },
			...
			},
			{
				...
				displayOptions: {
					show: {
						operation: ['getMessages', 'addMessage', 'deleteMessages', 'deleteLastMessages'],
					},
				},
				default: '',
			},
