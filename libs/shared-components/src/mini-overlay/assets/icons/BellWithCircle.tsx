...
const BellWithCircle = ({ isPrimary }: { isPrimary: boolean }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="15" height="16" viewBox="0 0 15 16" fill="none">
    <path
      ...
      fill={isPrimary ? 'white' : '#7A818B'}
      stroke={isPrimary ? 'white' : '#7A818B'}
      strokeLinecap="round"
    ...
    <path
      ...
      strokeLinejoin="round"
    />
    <circle cx="11.375" cy="3.5" r="3" fill={isPrimary ? 'white' : '#D9304F'} stroke={'white'} />
  </svg>
)
