...
export const envSchema = z
  .object({
    ...
    NFT_CONTRACT_OWNER_PRIVATE_KEY: z.string().optional(),
    NFT_CONTRACT_OWNER_ID: z.string().optional(),
    NFT_CONTRACT_ID: z.string().optional(),
    TELEGRAM_MONITORING_TOPIC_ID: z.string().optional(),
    TELEGRAM_MONITORING_CHAT_ID: z.string().optional(),
    REWARD_ACCOUNT_PRIVATE_KEY: z.string().optional(),
    REWARD_ACCOUNT_ID: z.string().optional(),
