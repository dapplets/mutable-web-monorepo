...
const Profile = ({ accountId, closeProfile, connectWallet, disconnectWallet, nearNetwork, trackingRefs, openCloseWalletPopupRef, }) => {
    const [waiting, setWaiting] = (0, react_1.useState)(false);
    const wrapperRef = (0, react_1.useRef)(null);
    (0, use_outside_1.useOutside)(wrapperRef, closeProfile, trackingRefs, openCloseWalletPopupRef);
