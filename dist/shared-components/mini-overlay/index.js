...
const SidePanelWrapper = styled_components_1.default.div `
  position: fixed;
  z-index: 5000;
  display: flex;
  width: 58px;
...
`;
const MutationIconWrapper = styled_components_1.default.button `
  display: flex;
  box-sizing: border-box;
  justify-content: center;
  align-items: center;
...
const Loading = styled_components_1.default.div `
  ...
  opacity: 0.8;
`;
const AppsWrapper = styled_components_1.default.div `
  display: flex;
  flex-direction: column;
  padding: 5px 6px;
  gap: 10px;
`;
const LabelAppCenter = styled_components_1.default.div `
  position: absolute;
  display: flex;
  justify-content: center;
  align-items: center;
...
const LabelAppTop = styled_components_1.default.div `
  ...
  cursor: pointer;
`;
const ButtonOpenWrapper = styled_components_1.default.div `
  display: flex;
  box-sizing: border-box;
  justify-content: center;
  align-items: center;
...
`;
const ButtonOpen = styled_components_1.default.button `
  display: flex;
  box-sizing: border-box;
  overflow: hidden;
  justify-content: center;
